...
all: $(BINARY) $(UNITTEST_BINARY) $(UNITTEST_COLORS) $(UNITTEST_WIDE_CHARS) $(UNITTEST_TIME)
...
clean:
	rm -rfv $(BINARY) $(OBJECTS) $(UNITTEST_BINARY) $(JUNK) $(UNITTEST_COLORS) *.o *.dSYM $(UNITTEST_WIDE_CHARS) $(UNITTEST_TIME)
