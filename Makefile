...
all: $(BINARY) $(UNITTEST_READ_ASCII) $(UNITTEST_COLORS) $(UNITTEST_WIDE_CHARS) $(UNITTEST_TIME) $(UNITTEST_CHARS)
...
clean:
	rm -rfv $(BINARY) $(OBJECTS) $(UNITTEST_READ_ASCII) $(JUNK) $(UNITTEST_COLORS) *.o *.dSYM $(UNITTEST_WIDE_CHARS) $(UNITTEST_TIME) $(UNITTEST_CHARS)
